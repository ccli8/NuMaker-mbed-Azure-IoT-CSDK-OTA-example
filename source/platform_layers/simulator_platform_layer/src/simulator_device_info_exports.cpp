...
static char* DeviceInfo_GetManufacturer()
{
    ...
    return nullptr;//strdup(lastReportedValue.c_str());
}
...
static char* DeviceInfo_GetProcessorManufacturer()
{
    ...
    {
        valueIsDirty = false;
        return nullptr;//strdup("GenuineIntel");
    }
